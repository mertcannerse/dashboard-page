...
let chart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            data: [[0, 2], [2, 4], [4, 6], [6, 8], [8, 10], [10, 12], [12, 14],], // Verileri tersine çevir
            label: ["0.20", "21.45", "22.50", "23.40"],
            backgroundColor: ['#BACCEA', '#8FB4EF', '#649BF4', '#0F6CFF', '#8FB4EF', '#0F6CFF'],
            ...
            x: {
                ...
                ticks: {
                    callback: function (value, index) {
                        ...
                        const myLabels = ['Pazartesi', "Salı", 'Çarşamba', "Perşembe", 'Cuma', "Cumartesi", 'Pazar'];
